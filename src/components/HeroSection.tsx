      ...
      <div className="container relative z-10 px-4 py-20">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-4 tracking-tight">
            <span className="text-gradient">{t('hero.title_cool')}</span>{" "}
            <span className="text-foreground">{t('hero.title_tips')}</span>
          </h1>
          ...
          <div className="flex gap-8 mb-10 text-muted-foreground">
            <div className="flex flex-col items-center">
              ...
              <span className="text-sm">{t('hero.subscribers')}</span>
            </div>
            <div className="w-px bg-border" />
            <div className="flex flex-col items-center">
              <span className="text-3xl font-bold text-foreground">64</span>
              <span className="text-sm">{t('hero.tutorials')}</span>
            </div>
          </div>
