...
export function ThemeToggle() {
  ...
  return (
    <div className="fixed bottom-8 left-8 z-[100] group">
      ...
      >
        <Sun className={`h-10 w-10 transition-all group-hover:text-primary group-hover:animate-wiggle 
          ${theme === 'dark' ? 'rotate-90 scale-0' : 'rotate-0 scale-100'}`} 
        />
        <Moon className={`absolute h-10 w-10 transition-all group-hover:text-secondary group-hover:animate-wiggle
